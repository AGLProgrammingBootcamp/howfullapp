...
class CavesControllerTest < ActionController::TestCase
  ...
  test "should create cafe" do
    assert_difference('Cafe.count') do
      post :create, cafe: { location: @cafe.location, name: @cafe.name, seat: @cafe.seat, smoking: @cafe.smoking }
    end
  ...
  test "should update cafe" do
    patch :update, id: @cafe, cafe: { location: @cafe.location, name: @cafe.name, seat: @cafe.seat, smoking: @cafe.smoking }
    assert_redirected_to cafe_path(assigns(:cafe))
  end
